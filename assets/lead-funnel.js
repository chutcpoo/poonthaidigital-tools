(() => {
  const MAP={
    ...
    '/bakery-production-capacity-calculator/':{slug:'bakery-capacity-starter',title:'Free Bakery Capacity Starter',etsy:'https://poonthaidigital.etsy.com/listing/4573789186',paid:'Bakery Production Schedule & Capacity Planner',why:'Upgrade when multiple orders and deadlines need batch and task scheduling, daily and weekly capacity checks, overload signals and next actions in one planner.'},
