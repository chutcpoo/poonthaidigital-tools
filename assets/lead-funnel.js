(() => {
  const MAP={
    ...
    '/invoice-aging-calculator/':{slug:'invoice-follow-up-starter',title:'Free Invoice Follow-Up Starter',etsy:'/invoice-payment-tracker/',paid:'Invoice Payment Tracker Excel',why:'Upgrade when multiple invoices, partial payments, promises to pay, aging and next follow-up actions need one connected repeatable workflow.'},
    '/free-resources/invoices/free-invoice-follow-up-starter-pack/':{slug:'invoice-follow-up-starter',title:'Free Invoice Follow-Up Starter',etsy:'/invoice-payment-tracker/',paid:'Invoice Payment Tracker Excel',why:'Upgrade when multiple invoices, partial payments, promises to pay, aging and next follow-up actions need one connected repeatable workflow.'}
  };
